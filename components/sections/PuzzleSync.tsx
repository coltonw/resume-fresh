...
import PuzzleSyncLine from "../iconLines/PuzzleSyncLine.tsx";
...
const PuzzleSync = () => (
  <>
    ...
    <Paragraph>
      ...
      api. I had been working with TypeScript at work a bit and so I started
      developing all side projects in TypeScript starting with this project. I
      deployed the frontend using CircleCI for CI/CD and Amazon S3 to host. I
